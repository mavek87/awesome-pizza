...
class OrdersServiceTest {
    ...
    @Test
    void get_all_orders_with_no_orders_found() {
    ...
    @Test
    void get_all_orders_with_some_orders_found() {
    ...
    @Test
    void get_order_doesnt_find_order() {
    ...
    @Test
    void get_next_order_to_prepare_is_ok() {
    ...
    @Test
    void get_next_order_to_prepare_with_any_other_orders_left_is_ok() {
    ...
    @Test
    void complete_order_work_as_expected_if_order_with_this_id_exists() {
        final Long id = order1.getId();
        when(ordersRepository.findById(id)).thenReturn(Optional.of(order1));
